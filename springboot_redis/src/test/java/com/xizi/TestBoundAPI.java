...
public class TestBoundAPI {
    ...
    public void testBound() {
        ...
        //追加一个值
        stringRedisTemplate.opsForValue().append("name", "帅");
        ...
        nameValueOperations.set("戏子");
        nameValueOperations.append("一顿操作666");
        String s1 = nameValueOperations.get();
        System.out.println(s1);


//        //对list set zset hash 进行绑定
        BoundListOperations<String, String> listsOperations = stringRedisTemplate.boundListOps("lists");
        listsOperations.leftPushAll("戏子z", "戏子zz", "戏子zz");
        //遍历全部
